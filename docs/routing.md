...
API enabling natural URL style (like `ohanadaily.com:4200/home/`), in opposition to Angular 1 which used the _hashbang_ hack
routing style (like `ohanadaily.com:4200/#/home/`).
